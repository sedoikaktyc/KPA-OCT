...
unsigned long buttTime[BUTTNUM] = {0};
///////////////////////////////////////////////////////////////////////////////
...
uint8_t oldRawPos[ENCNUM] = {127, 127, 127}; // Предыдущее положение энкодера
  ...
  int rawBorder[ENCNUM][2] = {{102, 81}, {39, 17}, {87, 127}};
  // Границы положений энкодера
  int encBorder[ENCNUM][2] = {{0, 10}, {0, 10}, {0, 4}};
...
/////////////
  ...
  long stepperTrueZeroPos[STEPPER_NUM] = {4}; // Положение нуля шкалы
  long stepperBorder[STEPPER_NUM][2] = {{0, 157}}; // Границы шкалы
